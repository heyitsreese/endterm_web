...
<div class="flex flex-col md:flex-row gap-6">
    ...
    <div class="flex-1 flex flex-col gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 object-cover">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" value="Sprint PHL" class="w-full bg-gray-50 border border-transparent rounded-lg px-4 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:bg-white transition" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                    <input type="email" value="sprintphl@gmail.com" class="w-full bg-gray-50 border border-transparent rounded-lg px-4 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:bg-white transition" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                    <input type="text" value="+1 (555) 123-4567" class="w-full bg-gray-50 border border-transparent rounded-lg px-4 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:bg-white transition" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Website</label>
                    <input type="text" value="www.sprintphl.com" class="w-full bg-gray-50 border border-transparent rounded-lg px-4 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:bg-white transition" />
                </div>
            </div>
            
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-1">Business Address</label>
                <input type="text" value="Unit 101-102, FUSION, Hilado St, Bacolod, 6100 Negros Occidental" class="w-full bg-gray-50 border border-transparent rounded-lg px-4 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:bg-white transition" />
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="flex flex-col gap-4 mb-6">
                ...
                <div class="flex items-center justify-between day-row">
